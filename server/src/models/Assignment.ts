...
export interface IAssignment extends Document {
  ...
  reminder12hSent: boolean        // đã gửi nhắc hạn 12h trước chưa (tránh gửi trùng)
  reminder5hSent: boolean         // đã gửi nhắc hạn 5h trước chưa
  isActive: boolean
  createdAt: Date
  updatedAt: Date
}
...
AssignmentSchema.index({ isActive: 1, dueDate: 1, reminder12hSent: 1 })
AssignmentSchema.index({ isActive: 1, dueDate: 1, reminder5hSent: 1 })
